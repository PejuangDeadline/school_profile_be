          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">List of Feature</h3>
              </div>
              ...
              <div class="card-body">
                ...
                <table id="tableFeature" class="table table-bordered table-striped">
                  <thead>
                  <tr>
                    <th>No</th>
                    <th>Branch ID</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button title="Delete Feature" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modal-delete{{ $data->id }}">
                    ...
                    <div class="modal fade" id="modal-delete{{ $data->id }}" tabindex="-1" aria-labelledby="modal-delete{{ $data->id }}-label" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                Are you sure you want to delete <label for="Feature">{{ $data->name_value }}</label>?
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
