                    ...
                    <div class="sbp-preview">
                        <div class="sbp-preview-content">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="my-editor form-control" id="my-editor" name="about" cols="30" rows="10"">{{ $profile->about }}</textarea>
                            </div>
                            <div class="mb-3">
                                <label><b>Vision</b></label>
                                <input class="form-control" id="id_inst" name="vision" type="text" placeholder="" value="{{ $profile->vision }}"/>
                            </div>
                            <div class="mb-3">
                                <label><b>Mission</b></label>
                                <input class="form-control" id="id_inst" name="mission" type="text" placeholder="" value="{{ $profile->mission }}"/>
                            </div>
